...
namespace DNNGo.Modules.LayerGallery {
	public class Resource_FilesStatus {
        ...
        public Resource_FilesStatus(DNNGo_LayerGallery_Files PhotoItem, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, PhotoItem.FileSize, ps, ModulePath); }

        public Resource_FilesStatus(DNNGo_LayerGallery_Files PhotoItem, int fileLength, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, fileLength, ps, ModulePath); }
        ...
        /// <returns></returns>
        public String GetPhotoPath(DNNGo_LayerGallery_Files media, PortalSettings ps)
        {
