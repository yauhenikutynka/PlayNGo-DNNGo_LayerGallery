...
namespace DNNGo.Modules.LayerGallery
{
	...
	public partial class DNNGo_LayerGallery_Item : Entity<DNNGo_LayerGallery_Item>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个内容项实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">项编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static DNNGo_LayerGallery_Item FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_LayerGallery_Item entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_LayerGallery_Item();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_LayerGallery_Item FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<DNNGo_LayerGallery_Item> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        /// <returns></returns>
        public static List<DNNGo_LayerGallery_Item> FindAll(Int32 SliderID)
        {
            ...
            qp.Where.Add(new SearchParam(_.ContentID, SliderID, SearchType.Equal));
