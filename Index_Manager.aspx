<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_Manager.aspx.cs" Inherits="DNNGo.Modules.LayerGallery.Index_Manager" %>
...
<script src="<%=ModulePath %>Resource/plugins/select2/select2.min.js"></script>
...
<div class="navbar navbar-inverse"> 
  ...
  <div class="container">
    ...
    <div class="navbar-tools hidden-xs"> 
        ...
        <asp:HyperLink ID="hlBuyIt" resourcekey="hlBuyIt" runat="server" Target="_blank" CssClass="btn btn-teal" NavigateUrl="http://www.dnngo.net/DNNStore/tabid/58/ProductID/468/Default.aspx" Text="<i class='fa clip-cart'></i> | Buy It" ToolTip="Buy It"></asp:HyperLink>
        <asp:HyperLink ID="hlDocumentation" resourcekey="hlDocumentation" runat="server" Target="_blank" CssClass="btn btn-teal" NavigateUrl="http://www.dnngo.net/doc/DNNGo_LayerGallery_V4/index.html" Text="<i class='fa clip-book'></i> | Documentation" ToolTip="Documentation"></asp:HyperLink>
	...
	<!-- start: FOOTER -->
		<div class="footer clearfix">
			<div class="footer-inner">
				2013 &copy; LayerGallery by <a href="http://www.dnngo.net/" target="_blank">dnngo.net</a>.
			</div>
